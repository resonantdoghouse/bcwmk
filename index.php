        ...
        <div class="container">
            <div class="row app-align-center">
                ...
                <div class="col-md-6 offset-md-1 col-sm-12 offset-sm-0">
                    ...
                    <p class="lead mb-4">We combine immediate real time events with rich historical data to help answer
                    ...
                    <div class="row hidden-md-down">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p>We process our data across a massively distributed network of reliable servers to ensure
        ...
        <div class="container text-xs-center">
            ...
            <div class="row app-marketing-grid">
                <div class="col-md-4 px-4 mb-5">
                    <img class="mb-1" src="<?php echo get_template_directory_uri() . '/assets/img/startup-9.svg' ?>">
                    <p><strong>24/7 support.</strong> We’re always here for you no matter what time of day.</p>
                </div>
                <div class="col-md-4 px-4 mb-5">
                    <img class="mb-1" src="<?php echo get_template_directory_uri() . '/assets/img/startup-10.svg' ?>">
                    <p><strong>E-commerce.</strong> We automatically handle all sales analytics.</p>
                </div>
                <div class="col-md-4 px-4 mb-5">
                    <img class="mb-1" src="<?php echo get_template_directory_uri() . '/assets/img/startup-11.svg' ?>">
            ...
            <div class="row app-marketing-grid">
                <div class="col-md-4 px-4 mb-5">
                    <img class="mb-1" src="<?php echo get_template_directory_uri() . '/assets/img/startup-12.svg' ?>">
                ...
                <div class="col-md-4 px-4 mb-5">
                    <img class="mb-1" src="<?php echo get_template_directory_uri() . '/assets/img/startup-14.svg' ?>">
